...
export default function SignInPage() {
  ...
  // Extract redirect callback or errors from URL
  ...
  return (
    <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-12 overflow-hidden bg-white text-slate-800 font-sans">
      ...
      <div className="hidden lg:block lg:col-span-7 xl:col-span-7 relative h-screen bg-slate-950">
        ...
        <motion.img
          ...
          src="/images/halftone_clouds.png"
          alt="Halftone Clouds Artwork"
          className="w-full h-full object-cover select-none mix-blend-lighten filter brightness-105 contrast-105"
        />
        ...
        <div className="absolute bottom-16 left-16 right-16 z-20 text-white max-w-lg">
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-xs font-semibold uppercase tracking-wider text-blue-light">
              ✨ ATS Resume Engine
            </div>
            <h2 className="font-cabinet font-extrabold text-4xl leading-tight">
              Design for the recruiters, optimize for the scanners.
            </h2>
            <p className="text-white/70 text-base font-medium leading-relaxed">
              Verify your templates, evaluate parsing performance, and safeguard your CV with the industry's most powerful ATS simulator.
            </p>
          </motion.div>
        </div>
