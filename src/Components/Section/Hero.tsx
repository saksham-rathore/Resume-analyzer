                    ...
                    <div className="flex flex-wrap gap-4 items-center">
                        <div className="flex items-center -space-x-3">
                            <img 
                                ...
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuC6NkpBaYvQkVUVKBCl4M8_ZifbD50YF4H89yufK4kBfhsj1LxzVzsdYcoJOL0RMToXhEewtDo3LjR81vIVQeIqgMB2A6PytTpb6Kp50LQcRT5kPXRN9G3zFoHPd7-btfwIMBJyAssoy9NdvaMciX2JYRKrfWPJz8VoYm5nyZy2v9FuAPndEK0GcKVbcjgDEd6p0_JQQkEilZoD7V45tmmMByCdtZp6MGfEvcZGA2rQPdP7bEmZfG7CAqmAkcH7DA6TMYOFd3rpyQ" 
                            />
                            <img 
                                className="w-10 h-10 rounded-full border-2 border-surface" 
                                alt="Young male professional" 
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDUmxqVOSFy-7eswQhmCoCz1ppQaGVu9jVQ197xqpKJjtJDjFTr3gF___JAcujndESWIjFjWsbTMscTWsecLczC-WVe4A2MFrzKH7CXdnAxAijsrlUD22tQiPsppTwGUFMFyG6xF67FsPvzie6SFcswirL24fdomyXv4Eyp84xGiSmBgIyFAyzMU3EOMKtypYBNyXf_Nz1HPxTTH-vRh4OYlalSO5jZVktEEoPHlaYYbVrgfrQzOv_WjiIliVVswCHSvUAaKr-f1A" 
                            />
                            <img 
                                className="w-10 h-10 rounded-full border-2 border-surface" 
                                alt="Female professional working" 
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDmYLChsWm6C8pn789GOSyzWIUYxAMr49OKiXlFTbGCvF9prbyITtB49pm61BpAP-bshIisD7i3CaG_LIrHH4sX_TwlJ9fQmSAv58lIl-zaDcc8kYQ6xgu4dhKoepqplZj-7plJdbUKt36OelrgMZrLdn1gyFi--WF8IT1TnBHuAO-k7DNXgXYqBKF62lCJJSKN12Qn_tKmUQLi23vjwJEZW0RQdM2mz4-Vf-dWVR01DcD4lQfwvO9OASEfJ780kTsEPlGL6_vcFQ" 
                            />
                        </div>
                        <span className="text-on-surface-variant font-label-md ml-3">Trusted by 10k+ professionals</span>
                    </div>
                </div>
